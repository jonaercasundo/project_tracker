        ...
        return (0, context_1.withNewSpanContext)(async () => {
            ...
            const finalizeCurrentOutput = async (preparedErrorOutput) => {
                ...
                await (0, guardrails_1.finalizeOutputGuardrails)({
                    ...
                    redactedOutput: blockedOutputPersistence_1.OUTPUT_GUARDRAIL_BLOCKED_TOOL_OUTPUT,
                    guardedTerminalToolOutput: (0, blockedOutputPersistence_1.hasTerminalToolOutputSource)(state),
                    signal: options.signal,
                    sanitizeRejectedOutput: blockedOutputPersistence_1.sanitizeBlockedTerminalToolOutput,
            ...
            try {
                while (true) {
                    ...
                    if (state._currentStep.type === 'next_step_interruption') {
                        ...
                        const approvedToolCheckpointDeferred = interruptedOutcome.approvedToolResumed &&
