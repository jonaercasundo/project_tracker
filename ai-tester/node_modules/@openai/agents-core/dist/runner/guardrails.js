...
async function finalizeOutputGuardrails(options) {
    ...
    try {
        ...
        const outputBlocked = sanitizeRejectedOutput(state, outputGuardrailResultStart, completedTripwireResult, observedResults, error instanceof errors_1.OutputGuardrailTripwireTriggered ? error : undefined, ownedGuardrailResults);
...
function sanitizeBlockedOutputGuardrailError(error, rejectedOutput, redactedOutput, state) {
